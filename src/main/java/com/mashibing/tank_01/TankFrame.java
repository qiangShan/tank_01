...
import com.mashibing.net.TankDirChangedMsg;
import com.mashibing.net.Client;
import com.mashibing.net.TankStartMovingMsg;
import com.mashibing.net.TankStopMsg;
...
public class TankFrame extends Frame {
    ...
    public void paint(Graphics graphics){
        *//**
        ...
        myTank.paint(graphics);   //主坦克

        for (int i=0;i<bullets.size();i++){  //子弹
            bullets.get(i).paint(graphics);
        }

        for(int i=0;i<tanks.size();i++){  //敌方坦克
